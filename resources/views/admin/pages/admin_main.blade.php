...
@section('content')
    <div x-data="getItems()" x-init="fetchData()">
        <div class="right_col" role="main">


            <!-- top tiles -->
        @include('admin.components.mainPage.top_titles_main_admin')
        <!-- /top tiles -->
            ...
            <div class="row">
                ...
                @include('admin.components.mainPage.commands_main_admin')
    ...
    @include('admin.components.mainPage.alpine_scripts_main_admin')
@endsection
